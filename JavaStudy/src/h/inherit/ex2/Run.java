...
public class Run {
	 ...
	 * (실제로 상속된 클래스를 통해서 객체생성시 부모클래스의 객체도 생성된다.)
	 * 
	 * 상속의 장점
	 ...
	 * - 부모클래스에 정의되어있는 protected 필드는 자식클래스에서 직접접근이 가능하다(private 은 불가)
	 * - 자식객체는 부모클래스에 있는 메소드를 내것처럼 호출할 수 있다.
	...
	public static void main(String[] args) {
		...
		//Product 클래스를 상속받는 TV클래스 작성
		//필드에는 int inch정보를 가지고 있고 information 을 오버라이딩하여 기본 product의 정보 + inch정보를 출력

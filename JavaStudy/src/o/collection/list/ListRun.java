...
public class ListRun {
	 ...
	 * 
	 * -자료구조 : 방대한 데이터를 보다 효율적으로 관리(추가, 삭제, 정렬, 수정)할 수 있도록 도와주는 개념
	 ...
	 * 
	 * 		2.중간에 값을 추가한다거나 삭제하는 경우 값을 담겨주는 작업(알고리즘)을 직접 기술할 필요가 없다.
	...
	public static void main(String[] args) {
		List list = new ArrayList(10); //크기 기정을 할수도 있고 안해도 괜찮다.
		...
		list.add(new Music("용서해", "임창정"));
		list.add("끝");
		
		//지정된 크기보다 더 많이 넣어도 오류가 발생하지 않는다 -> 장점1. 크기제약x
		//다양한 타입의 데이터를 담을 수 있음 -> 장점3. 여러타입 보관가능
		
		System.out.println(list); //list 특징 : 순서유지하면서 담김(0번 인덱스부터 차곡차곡)
		...
		//4. set(int index, E e) : 해당 인덱스우치의 값을 전달받은 e객체로 변경
		list.set(2, new Music("고민중독","qwer"));
		
		//5. size() : 리스트의 사용죽인 사이즈를 반환시켜주는 메소드
		System.out.println(list.size());
		
		//6. get(int index) : 해당 인덱스위에 객체 반환시켜주는 메소드

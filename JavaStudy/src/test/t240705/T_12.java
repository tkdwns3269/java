...
public class T_12 {
	public static void main(String[] args) {
		 ...
		 * 몇 번의 승부에서 몇번 이기고 몇 번 비기고 몇 번 졌는지 출력하세요.
		 * 
		 * 당신의 이름을 입력해주세요 : 박상준			가위바위보 : exit
		...
		//String com = comArr[(int) (Math.random() * 3)]; // 0(가위) 1(바위) 2(보)
		...
		while (true) {
			...
			String com = comArr[rand];
			/*
			 * 컴퓨터에 랜덤으로 "가위, 바위 보"중 하나를 부여해준다

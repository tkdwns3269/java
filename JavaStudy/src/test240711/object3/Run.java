...
public class Run {
	public static void main(String[] args) {
		...
		/*
		 	우리는 도서관에서 책을 관리하는 프로그램을 만드려고 한다.
		 	해당 클래스는 도서관에 책을 등록할 떄 사용하는 book 객체를 생성할 Book 클래스이다.
...
//				break;
			case 3:
				...
				for(int i = 0; i < bArr.length; i++) {
					if(bArr[i] == null) {  // null 을 발견하면 뒤에 데이터는 null 이므로 반복종료
						break;
...
//					System.out.println(b1.toString());
//				} else if (b2 != null && target.equals(b2.toString())) {
//					System.out.println(b2.toString());
//				} else if (b3 != null && target.equals(b3.toString())) {
//					System.out.println(b3.toString());
//				} else {
